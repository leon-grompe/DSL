...
![Layers with Phases](../img/best-practices/LayersWithPhases.png)
...
### Pipeline activities
Each of these phases consists of **[activities]**(activities.md) (basically sub-tasks) that are used to achieve the concept of a given layer.
