...
## <code class="doc-symbol doc-symbol-static-function"></code> `fromPretrainedModel` {#safeds.ml.nn.NeuralNetworkClassifier.fromPretrainedModel data-toc-label='[static-function] fromPretrainedModel'}
